...
export const discoverCopy = {
  ...
  eraInstruction: localizedText("Arraste para seguir de era.", {
    en: "Swipe to move through the era.",
  }),
  ...
  eraVibeTitle: localizedText("Clima educacional com piada interna", {
    en: "Educational vibe with an inside joke",
  }),
