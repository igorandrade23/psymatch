...
export const schoolEras: SchoolEra[] = [
  {
    ...
    periodLabel: localizedText("A partir de 1879"),
  ...
  },
  {
    ...
    periodLabel: localizedText("A partir da década de 1890"),
    ...
    vibe: localizedText(
      "Aqui a pergunta não é só o que você sente, mas como isso te ajuda a viver, escolher e sobreviver ao caos do cotidiano com alguma dignidade científica.",
    ),
  ...
  },
  {
    ...
    periodLabel: localizedText("A partir de 1913"),
...
export const psychologists: Psychologist[] = [
  ...
  },
  {
    ...
    ageLabel: localizedText("40 anos"),
  ...
  },
  {
    ...
    ageLabel: localizedText("45 anos"),
  ...
  },
  {
    ...
    ageLabel: localizedText("50 anos"),
  ...
  },
  {
    ...
    ageLabel: localizedText("42 anos"),
...
export const discoverItems: DiscoverItem[] = [
  ...
  { type: "profile", profileSlug: "ivan-pavlov", order: 6 },
  { type: "profile", profileSlug: "edward-thorndike", order: 7 },
  { type: "era", eraSlug: "behaviorismo", order: 8 },
  { type: "profile", profileSlug: "john-broadus-watson", order: 9 },
  { type: "profile", profileSlug: "burrhus-frederic-skinner", order: 10 },
];
